...
class HistoryRetryContactItem extends StatefulWidget {
  final ShareStatus data;

  const HistoryRetryContactItem({required this.data});

  @override
  State<HistoryRetryContactItem> createState() =>
      _HistoryRetryContactItemState();
}

class _HistoryRetryContactItemState extends State<HistoryRetryContactItem> {
